<?php
    ...
    if($_FILES["Arquivo"]["size"] > 0){
        ...
        */ 
        ...
        //aqui sera gravado no banco a funcao gravar do institucional.class que no caso eh referenciada abaixo no require
        ...
        echo "<script>alert('institucional alterado com sucesso!');</script>";
