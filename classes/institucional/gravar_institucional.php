    ...
    if(isset($_POST["titulo"]) && !empty($_POST["titulo"]) && isset($_POST["texto"]) && !empty($_POST["texto"])){
        ...
        */ 
        ...
        if(move_uploaded_file($file["tmp_name"], "$dir/".$file["name"])){
            ...
            //nessa parte (que ainda nao estah 100 por cento pronta) pegamos a extensao do arquivo e verificamos se ele pertence a alum tipo pre definido, caso nao sera disparado um ALERT avisando que o tipo do arquivo eh invalido, caso contratio o arquivo eh enviado para a funcao responsavel por gravar no banco de dados
            if(pathinfo($imagem, PATHINFO_EXTENSION) != 'pdf' && pathinfo($imagem, PATHINFO_EXTENSION) != 'png' && pathinfo($imagem, PATHINFO_EXTENSION) != 'jpg' && pathinfo($imagem, PATHINFO_EXTENSION) != 'jpeg' && pathinfo($imagem, PATHINFO_EXTENSION) != 'gif'){
                ...
                $url = '/paginas/admin/main.php?pagina=../../paginas/cadastros/cadastrar_institucional';
