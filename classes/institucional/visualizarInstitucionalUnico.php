...
<div class='infoContainer' style='background-color: white; box-shadow: 10px; background-color: #ffffff;  border-top-left-radius: 40px; border-top-right-radius: 40px; border-bottom-left-radius: 40px; table-layout:fixed;  max-width: 1100px; word-wrap: break-word; !important; margin-left: 200px; margin-top: 50px; padding: 20px;'>
                        ...
                        if($i->retornaInstitucionalLido($idInstitucional) == 0){
                            echo "<div class='row'>";
                                echo "<div class='col-md-2 offset-md-1'>";
                                    echo "<a style='color: white !important' href='/paginas/admin/main.php?pagina=../../paginas/institucional/inicio' class='btn btn-danger'>Cancelar</a>";
                                echo "</div>";
