...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21-Jul-2021 às 17:05
...
(20, 'Relatórios Report Service', 'http://192.168.0.213/Relatorio', 1, 0, 1, 1);
...
INSERT INTO `acesso_grupo` (`id`, `nome`, `ativo`, `excluido`, `permissao`, `interno`) VALUES
(1, 'Publico', 1, 0, 1, 1),
(2, 'ASC', 1, 0, 2, 0),
(3, 'Impressoras', 1, 0, 2, 0),
(4, 'Tecnologia da Informação', 1, 0, 2, 1),
(5, 'Logado', 1, 1, 2, 1);
...
(4, 'Andre luiz Bueno Nascimento', '8', '1981-01-25', 1, 0),
...
(8, 'Clelia Paixao Almeida de Oliveira', '13', '1963-04-12', 1, 0),
...
(14, 'Gabriela Cristina Silva', '13', '1994-02-07', 1, 0),
(15, 'Gilberto Silva Teixeira', '8', '1952-05-13', 1, 0),
(16, 'Gilcimara Prestes de Andrade', '13', '1976-11-29', 1, 0),
...
(24, 'Joao Victor Borges de Andrade', '13', '1998-09-23', 1, 0),
(25, 'Karen Alexandra Nascimento dos Santos', '9', '1993-02-08', 1, 0),
(26, 'Karen Larissa Tenebra Pereira', '13', '1997-03-14', 1, 0),
